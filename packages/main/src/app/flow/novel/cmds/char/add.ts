...
import charTpl from '../../prompt/world/char.emd'
...
export default async function (exeCtx: ExecutionContext, args: Record<string, any> = {}) {
    ...
    console.log("character =", result.json)
}