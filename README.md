...
**A meta-agent that automatically generates agents -- Evolving LLM from Intuition to Logic,A Logic-Driven Workflow Orchestration System that Automatically Creates Agents for Complex Task**
